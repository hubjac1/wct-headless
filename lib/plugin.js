...
const plugin = (wct, pluginOptions) => {
    ...
    const onConfigure = () => __awaiter(this, void 0, void 0, function* () {
        ...
        const expanded = yield browsers.expand(names, pluginOptions.browsersOptions);
        wct.emit('log:debug', 'Expanded local browsers:', names, 'into capabilities:', expanded, 'with browsersOptions:', pluginOptions.browsersOptions);
